...
export default function Projects() {
    return (
			<motion.section transition={transition1_s}>
				<div className="container mx-auto flex flex-col items-center gap-y-[8rem]">
					{/* title  */}
					<div className="flex flex-col text-center mt-20 gap-y-12">
						...
						<motion.div variants={upward} initial="variantInit" whileInView="variantAnim" transition={transition1_d} viewport={{once: true}} >
							<p className={`${archivo.className} p text-[1.5rem]`}>Cras volutpat, libero et euismod semper, neque orci rhoncus magna, eu venenatis tortor nibh at purus. Vivamus sit amet commodo tortor.</p>
						</motion.div>
					</div>
